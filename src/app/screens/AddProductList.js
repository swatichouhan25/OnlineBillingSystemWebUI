  ...
  return (
    <Grid
      ...
      <Paper elevation={10} style={paperStyle}>
        <div style={{ backgroundColor: 'blue', width: 650, height: 50 }}>
          <h3 style={{ color: 'white' }}>Add Product In The List </h3>
        </div>
        <Grid item xs={12}>
          {/* <TextField style={{ margin: 10 }} label="Store ID" variant="outlined" name="storeId" onChange={(e) => setData({ ...data, [e.target.name]: e.target.value })} fullWidth></TextField> */}
